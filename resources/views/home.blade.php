...
?>
    ...
    <h1>Next Meetup</h1>
    <p><strong>What?</strong> <a href="<?php echo $meetupUrl;?>">PHP Dublin &mdash; September 2015</a></p>
    ...
    <br>Our second talk is from <b>Barry O Sullivan</b> and it's about laravel 5.1, and how we used it's feature to make the site/blog easy to use and update.</p>
